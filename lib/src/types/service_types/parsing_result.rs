...
pub struct ParsingResult {
    ...
    pub data_status_codes: Option<Vec<crate::types::status_code::StatusCode>>,
    pub data_diagnostic_infos: Option<Vec<crate::types::diagnostic_info::DiagnosticInfo>>,
}
impl crate::types::MessageInfo for ParsingResult {
    fn object_id(&self) -> crate::types::ObjectId {
        crate::types::ObjectId::ParsingResult_Encoding_DefaultBinary
    }
}
impl crate::types::BinaryEncoder<ParsingResult> for ParsingResult {
