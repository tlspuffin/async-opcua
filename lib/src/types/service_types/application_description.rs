...
impl crate::types::BinaryEncoder<ApplicationDescription> for ApplicationDescription {
    ...
    fn decode<S: std::io::Read>(
        ...
        let application_uri = <crate::types::string::UAString as crate::types::BinaryEncoder<
