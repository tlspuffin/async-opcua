...
impl crate::types::BinaryEncoder<CreateMonitoredItemsResponse> for CreateMonitoredItemsResponse {
    ...
    fn decode<S: std::io::Read>(
        ...
        > as crate::types::BinaryEncoder<
            Option<Vec<super::monitored_item_create_result::MonitoredItemCreateResult>>,
        >>::decode(stream, decoding_options)?;
