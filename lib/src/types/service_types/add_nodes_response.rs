...
impl crate::types::MessageInfo for AddNodesResponse {
    fn object_id(&self) -> crate::types::ObjectId {
        crate::types::ObjectId::AddNodesResponse_Encoding_DefaultBinary
    }
}
impl crate::types::BinaryEncoder<AddNodesResponse> for AddNodesResponse {
    ...
    fn decode<S: std::io::Read>(
        ...
        > as crate::types::BinaryEncoder<
            Option<Vec<super::add_nodes_result::AddNodesResult>>,
        >>::decode(stream, decoding_options)?;
