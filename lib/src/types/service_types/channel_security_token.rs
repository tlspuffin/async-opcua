...
pub struct ChannelSecurityToken {
    pub channel_id: u32,
    pub token_id: u32,
    pub created_at: crate::types::date_time::DateTime,
    pub revised_lifetime: u32,
}
impl crate::types::MessageInfo for ChannelSecurityToken {
...
impl crate::types::BinaryEncoder<ChannelSecurityToken> for ChannelSecurityToken {
    ...
    fn decode<S: std::io::Read>(
        ...
        let token_id = <u32 as crate::types::BinaryEncoder<u32>>::decode(stream, decoding_options)?;
