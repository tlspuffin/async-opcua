...
impl crate::types::BinaryEncoder for RelativePathElement {
    ...
    fn decode<S: std::io::Read>(
        ...
        let is_inverse = <bool as crate::types::BinaryEncoder>::decode(
            stream,
            decoding_options,
        )?;
        ...
        let target_name = <crate::types::qualified_name::QualifiedName as crate::types::BinaryEncoder>::decode(
            stream,
            decoding_options,
        )?;
        Ok(Self {
