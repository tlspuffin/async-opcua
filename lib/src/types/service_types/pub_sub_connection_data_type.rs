...
impl crate::types::BinaryEncoder<PubSubConnectionDataType> for PubSubConnectionDataType {
    ...
    fn decode<S: std::io::Read>(
        ...
        > as crate::types::BinaryEncoder<
            Option<Vec<super::writer_group_data_type::WriterGroupDataType>>,
        >>::decode(stream, decoding_options)?;
        let reader_groups = <Option<
            Vec<super::reader_group_data_type::ReaderGroupDataType>,
        > as crate::types::BinaryEncoder<
            Option<Vec<super::reader_group_data_type::ReaderGroupDataType>>,
        >>::decode(stream, decoding_options)?;
        Ok(Self {
            name,
            enabled,
