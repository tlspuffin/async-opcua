...
pub struct ReadResponse {
    ...
    pub results: Option<Vec<crate::types::data_value::DataValue>>,
    pub diagnostic_infos: Option<Vec<crate::types::diagnostic_info::DiagnosticInfo>>,
}
impl crate::types::MessageInfo for ReadResponse {
    fn object_id(&self) -> crate::types::ObjectId {
        crate::types::ObjectId::ReadResponse_Encoding_DefaultBinary
    }
}
impl crate::types::BinaryEncoder<ReadResponse> for ReadResponse {
