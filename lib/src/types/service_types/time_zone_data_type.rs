...
impl crate::types::MessageInfo for TimeZoneDataType {
...
impl crate::types::BinaryEncoder<TimeZoneDataType> for TimeZoneDataType {
    ...
    fn decode<S: std::io::Read>(
        ...
        let offset = <i16 as crate::types::BinaryEncoder<i16>>::decode(stream, decoding_options)?;
        let daylight_saving_in_offset =
