...
impl crate::types::MessageInfo for TransferSubscriptionsResponse {
    fn object_id(&self) -> crate::types::ObjectId {
        crate::types::ObjectId::TransferSubscriptionsResponse_Encoding_DefaultBinary
    }
}
impl crate::types::BinaryEncoder<TransferSubscriptionsResponse> for TransferSubscriptionsResponse {
    ...
    fn decode<S: std::io::Read>(
        ...
        let results =
            <Option<Vec<super::transfer_result::TransferResult>> as crate::types::BinaryEncoder<
