...
pub struct CallMethodRequest {
    pub object_id: crate::types::node_id::NodeId,
    pub method_id: crate::types::node_id::NodeId,
    pub input_arguments: Option<Vec<crate::types::variant::Variant>>,
}
impl crate::types::MessageInfo for CallMethodRequest {
