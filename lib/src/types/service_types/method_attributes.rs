...
impl crate::types::BinaryEncoder for MethodAttributes {
    ...
    fn decode<S: std::io::Read>(
        ...
        let executable = <bool as crate::types::BinaryEncoder>::decode(
            stream,
            decoding_options,
        )?;
        let user_executable = <bool as crate::types::BinaryEncoder>::decode(
            stream,
            decoding_options,
        )?;
        Ok(Self {
