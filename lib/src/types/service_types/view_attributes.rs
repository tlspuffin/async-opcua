...
impl crate::types::BinaryEncoder for ViewAttributes {
    ...
    fn decode<S: std::io::Read>(
        ...
        let contains_no_loops = <bool as crate::types::BinaryEncoder>::decode(
            stream,
            decoding_options,
        )?;
        let event_notifier = <u8 as crate::types::BinaryEncoder>::decode(
            stream,
            decoding_options,
        )?;
        Ok(Self {
