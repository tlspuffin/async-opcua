...
impl crate::types::BinaryEncoder<ThreeDOrientation> for ThreeDOrientation {
    ...
    fn decode<S: std::io::Read>(
        ...
        let a = <f64 as crate::types::BinaryEncoder<f64>>::decode(stream, decoding_options)?;
        let b = <f64 as crate::types::BinaryEncoder<f64>>::decode(stream, decoding_options)?;
        let c = <f64 as crate::types::BinaryEncoder<f64>>::decode(stream, decoding_options)?;
        Ok(Self { a, b, c })
    }
}
