...
impl crate::types::BinaryEncoder<AttributeOperand> for AttributeOperand {
    ...
    fn decode<S: std::io::Read>(
        ...
        let alias = <crate::types::string::UAString as crate::types::BinaryEncoder<
            crate::types::string::UAString,
        >>::decode(stream, decoding_options)?;
        let browse_path = <super::relative_path::RelativePath as crate::types::BinaryEncoder<
