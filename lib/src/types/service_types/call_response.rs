...
impl crate::types::MessageInfo for CallResponse {
    fn object_id(&self) -> crate::types::ObjectId {
        crate::types::ObjectId::CallResponse_Encoding_DefaultBinary
    }
}
impl crate::types::BinaryEncoder<CallResponse> for CallResponse {
    ...
    fn decode<S: std::io::Read>(
        ...
        > as crate::types::BinaryEncoder<
            Option<Vec<super::call_method_result::CallMethodResult>>,
        >>::decode(stream, decoding_options)?;
