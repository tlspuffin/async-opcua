...
impl crate::types::BinaryEncoder<UserNameIdentityToken> for UserNameIdentityToken {
    ...
    fn decode<S: std::io::Read>(
        ...
        let user_name = <crate::types::string::UAString as crate::types::BinaryEncoder<
            crate::types::string::UAString,
        >>::decode(stream, decoding_options)?;
        let password = <crate::types::byte_string::ByteString as crate::types::BinaryEncoder<
