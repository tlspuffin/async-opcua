...
impl crate::types::MessageInfo for EndpointConfiguration {
...
impl crate::types::BinaryEncoder<EndpointConfiguration> for EndpointConfiguration {
    ...
    fn decode<S: std::io::Read>(
        ...
        let max_buffer_size =
            <i32 as crate::types::BinaryEncoder<i32>>::decode(stream, decoding_options)?;
        let channel_lifetime =
            <i32 as crate::types::BinaryEncoder<i32>>::decode(stream, decoding_options)?;
        let security_token_lifetime =
            <i32 as crate::types::BinaryEncoder<i32>>::decode(stream, decoding_options)?;
        Ok(Self {
            operation_timeout,
            use_binary_encoding,
