...
impl crate::types::BinaryEncoder for PublishedDataSetDataType {
    ...
    fn decode<S: std::io::Read>(
        ...
        > as crate::types::BinaryEncoder>::decode(stream, decoding_options)?;
        let data_set_source = <crate::types::extension_object::ExtensionObject as crate::types::BinaryEncoder>::decode(
            stream,
            decoding_options,
        )?;
        Ok(Self {
