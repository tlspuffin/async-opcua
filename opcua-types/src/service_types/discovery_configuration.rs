...
impl crate::MessageInfo for DiscoveryConfiguration {
    fn object_id(&self) -> crate::ObjectId {
        crate::ObjectId::DiscoveryConfiguration_Encoding_DefaultBinary
    }
}
impl crate::BinaryEncoder for DiscoveryConfiguration {
