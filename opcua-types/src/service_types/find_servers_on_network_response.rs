...
pub struct FindServersOnNetworkResponse {
    ...
    pub last_counter_reset_time: crate::date_time::DateTime,
    pub servers: Option<Vec<super::server_on_network::ServerOnNetwork>>,
}
impl crate::MessageInfo for FindServersOnNetworkResponse {
    fn object_id(&self) -> crate::ObjectId {
        crate::ObjectId::FindServersOnNetworkResponse_Encoding_DefaultBinary
    }
}
impl crate::BinaryEncoder for FindServersOnNetworkResponse {
    ...
    fn decode<S: std::io::Read>(
        ...
        let last_counter_reset_time = <crate::date_time::DateTime as crate::BinaryEncoder>::decode(
                stream,
                decoding_options,
            )
