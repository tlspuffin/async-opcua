...
impl crate::MessageInfo for HistoryUpdateResponse {
    fn object_id(&self) -> crate::ObjectId {
        crate::ObjectId::HistoryUpdateResponse_Encoding_DefaultBinary
    }
}
impl crate::BinaryEncoder for HistoryUpdateResponse {
