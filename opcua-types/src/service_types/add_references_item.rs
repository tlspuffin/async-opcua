...
impl crate::MessageInfo for AddReferencesItem {
    fn object_id(&self) -> crate::ObjectId {
        crate::ObjectId::AddReferencesItem_Encoding_DefaultBinary
    }
}
impl crate::BinaryEncoder for AddReferencesItem {
    ...
    fn decode<S: std::io::Read>(
        ...
        let target_server_uri = <crate::string::UAString as crate::BinaryEncoder>::decode(
            stream,
            decoding_options,
        )?;
        ...
        let target_node_class = <super::enums::NodeClass as crate::BinaryEncoder>::decode(
            stream,
            decoding_options,
        )?;
        Ok(Self {
