...
impl crate::MessageInfo for DeleteNodesResponse {
    fn object_id(&self) -> crate::ObjectId {
        crate::ObjectId::DeleteNodesResponse_Encoding_DefaultBinary
    }
}
impl crate::BinaryEncoder for DeleteNodesResponse {
