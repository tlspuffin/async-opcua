...
pub struct Annotation {
    pub message: crate::string::UAString,
    pub user_name: crate::string::UAString,
    pub annotation_time: crate::date_time::DateTime,
}
impl crate::MessageInfo for Annotation {
    fn object_id(&self) -> crate::ObjectId {
        crate::ObjectId::Annotation_Encoding_DefaultBinary
    }
}
impl crate::BinaryEncoder for Annotation {
    ...
    fn decode<S: std::io::Read>(
        ...
        let message = <crate::string::UAString as crate::BinaryEncoder>::decode(
            stream,
            decoding_options,
        )?;
        ...
        let annotation_time = <crate::date_time::DateTime as crate::BinaryEncoder>::decode(
            stream,
            decoding_options,
        )?;
        Ok(Self {
