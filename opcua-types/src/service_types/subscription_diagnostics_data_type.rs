...
impl crate::MessageInfo for SubscriptionDiagnosticsDataType {
    fn object_id(&self) -> crate::ObjectId {
        crate::ObjectId::SubscriptionDiagnosticsDataType_Encoding_DefaultBinary
    }
}
impl crate::BinaryEncoder for SubscriptionDiagnosticsDataType {
    ...
    fn decode<S: std::io::Read>(
        ...
        let max_keep_alive_count = <u32 as crate::BinaryEncoder>::decode(
            stream,
            decoding_options,
        )?;
        let max_lifetime_count = <u32 as crate::BinaryEncoder>::decode(
            stream,
            decoding_options,
        )?;
        ...
        let modify_count = <u32 as crate::BinaryEncoder>::decode(
            stream,
            decoding_options,
        )?;
        let enable_count = <u32 as crate::BinaryEncoder>::decode(
            stream,
            decoding_options,
        )?;
        let disable_count = <u32 as crate::BinaryEncoder>::decode(
            stream,
            decoding_options,
        )?;
        let republish_request_count = <u32 as crate::BinaryEncoder>::decode(
            stream,
            decoding_options,
        )?;
        let republish_message_request_count = <u32 as crate::BinaryEncoder>::decode(
            stream,
            decoding_options,
        )?;
        let republish_message_count = <u32 as crate::BinaryEncoder>::decode(
            stream,
            decoding_options,
        )?;
        let transfer_request_count = <u32 as crate::BinaryEncoder>::decode(
            stream,
            decoding_options,
        )?;
        let transferred_to_alt_client_count = <u32 as crate::BinaryEncoder>::decode(
            stream,
            decoding_options,
        )?;
        let transferred_to_same_client_count = <u32 as crate::BinaryEncoder>::decode(
            stream,
            decoding_options,
        )?;
        let publish_request_count = <u32 as crate::BinaryEncoder>::decode(
            stream,
            decoding_options,
        )?;
        let data_change_notifications_count = <u32 as crate::BinaryEncoder>::decode(
            stream,
            decoding_options,
        )?;
        let event_notifications_count = <u32 as crate::BinaryEncoder>::decode(
            stream,
            decoding_options,
        )?;
        let notifications_count = <u32 as crate::BinaryEncoder>::decode(
            stream,
            decoding_options,
        )?;
        let late_publish_request_count = <u32 as crate::BinaryEncoder>::decode(
            stream,
            decoding_options,
        )?;
        let current_keep_alive_count = <u32 as crate::BinaryEncoder>::decode(
            stream,
            decoding_options,
        )?;
        let current_lifetime_count = <u32 as crate::BinaryEncoder>::decode(
            stream,
            decoding_options,
        )?;
        let unacknowledged_message_count = <u32 as crate::BinaryEncoder>::decode(
            stream,
            decoding_options,
        )?;
        let discarded_message_count = <u32 as crate::BinaryEncoder>::decode(
            stream,
            decoding_options,
        )?;
        ...
        let monitoring_queue_overflow_count = <u32 as crate::BinaryEncoder>::decode(
            stream,
            decoding_options,
        )?;
        let next_sequence_number = <u32 as crate::BinaryEncoder>::decode(
            stream,
            decoding_options,
        )?;
        let event_queue_over_flow_count = <u32 as crate::BinaryEncoder>::decode(
            stream,
            decoding_options,
        )?;
        Ok(Self {
