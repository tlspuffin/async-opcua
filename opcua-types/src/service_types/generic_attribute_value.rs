...
impl crate::MessageInfo for GenericAttributeValue {
    fn object_id(&self) -> crate::ObjectId {
        crate::ObjectId::GenericAttributeValue_Encoding_DefaultBinary
    }
}
impl crate::BinaryEncoder for GenericAttributeValue {
