...
pub struct ContentFilterElementResult {
    ...
    pub operand_status_codes: Option<Vec<crate::status_code::StatusCode>>,
    pub operand_diagnostic_infos: Option<Vec<crate::diagnostic_info::DiagnosticInfo>>,
}
impl crate::MessageInfo for ContentFilterElementResult {
    fn object_id(&self) -> crate::ObjectId {
        crate::ObjectId::ContentFilterElementResult_Encoding_DefaultBinary
    }
}
impl crate::BinaryEncoder for ContentFilterElementResult {
