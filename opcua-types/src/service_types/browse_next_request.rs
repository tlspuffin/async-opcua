...
pub struct BrowseNextRequest {
    ...
    pub continuation_points: Option<Vec<crate::byte_string::ByteString>>,
}
impl crate::MessageInfo for BrowseNextRequest {
    fn object_id(&self) -> crate::ObjectId {
        crate::ObjectId::BrowseNextRequest_Encoding_DefaultBinary
    }
}
impl crate::BinaryEncoder for BrowseNextRequest {
