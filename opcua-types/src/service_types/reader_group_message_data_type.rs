...
impl crate::MessageInfo for ReaderGroupMessageDataType {
    fn object_id(&self) -> crate::ObjectId {
        crate::ObjectId::ReaderGroupMessageDataType_Encoding_DefaultBinary
    }
}
impl crate::BinaryEncoder for ReaderGroupMessageDataType {
