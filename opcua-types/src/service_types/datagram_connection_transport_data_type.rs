...
pub struct DatagramConnectionTransportDataType {
    pub discovery_address: crate::extension_object::ExtensionObject,
}
impl crate::BinaryEncoder for DatagramConnectionTransportDataType {
    ...
    fn decode<S: std::io::Read>(
        ...
        let discovery_address = <crate::extension_object::ExtensionObject as crate::BinaryEncoder>::decode(
            stream,
            decoding_options,
        )?;
