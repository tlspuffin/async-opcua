...
impl crate::BinaryEncoder for DataSetMetaDataType {
    ...
    fn decode<S: std::io::Read>(
        ...
        let configuration_version = <super::configuration_version_data_type::ConfigurationVersionDataType as crate::BinaryEncoder>::decode(
            stream,
            decoding_options,
        )?;
        Ok(Self {
