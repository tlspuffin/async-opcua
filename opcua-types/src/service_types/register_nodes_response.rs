...
pub struct RegisterNodesResponse {
    ...
    pub registered_node_ids: Option<Vec<crate::node_id::NodeId>>,
}
impl crate::MessageInfo for RegisterNodesResponse {
    fn object_id(&self) -> crate::ObjectId {
        crate::ObjectId::RegisterNodesResponse_Encoding_DefaultBinary
    }
}
impl crate::BinaryEncoder for RegisterNodesResponse {
