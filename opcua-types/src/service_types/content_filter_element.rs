...
pub struct ContentFilterElement {
    ...
    pub filter_operands: Option<Vec<crate::extension_object::ExtensionObject>>,
}
impl crate::MessageInfo for ContentFilterElement {
    fn object_id(&self) -> crate::ObjectId {
        crate::ObjectId::ContentFilterElement_Encoding_DefaultBinary
    }
}
impl crate::BinaryEncoder for ContentFilterElement {
    ...
    fn decode<S: std::io::Read>(
        ...
        let filter_operator = <super::enums::FilterOperator as crate::BinaryEncoder>::decode(
            stream,
            decoding_options,
        )?;
