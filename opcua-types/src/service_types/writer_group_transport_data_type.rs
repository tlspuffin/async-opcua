...
impl crate::MessageInfo for WriterGroupTransportDataType {
    fn object_id(&self) -> crate::ObjectId {
        crate::ObjectId::WriterGroupTransportDataType_Encoding_DefaultBinary
    }
}
impl crate::BinaryEncoder for WriterGroupTransportDataType {
