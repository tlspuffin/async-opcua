...
pub struct RegisteredServer {
    ...
    pub server_names: Option<Vec<crate::localized_text::LocalizedText>>,
    pub server_type: super::enums::ApplicationType,
    pub gateway_server_uri: crate::string::UAString,
    pub discovery_urls: Option<Vec<crate::string::UAString>>,
    pub semaphore_file_path: crate::string::UAString,
    pub is_online: bool,
}
impl crate::MessageInfo for RegisteredServer {
    fn object_id(&self) -> crate::ObjectId {
        crate::ObjectId::RegisteredServer_Encoding_DefaultBinary
    }
}
impl crate::BinaryEncoder for RegisteredServer {
    ...
    fn decode<S: std::io::Read>(
        ...
        let server_names = <Option<
            Vec<crate::localized_text::LocalizedText>,
        > as crate::BinaryEncoder>::decode(stream, decoding_options)?;
        let server_type = <super::enums::ApplicationType as crate::BinaryEncoder>::decode(
            stream,
            decoding_options,
        )?;
        let gateway_server_uri = <crate::string::UAString as crate::BinaryEncoder>::decode(
            stream,
            decoding_options,
        )?;
        ...
        > as crate::BinaryEncoder>::decode(stream, decoding_options)?;
        let semaphore_file_path = <crate::string::UAString as crate::BinaryEncoder>::decode(
            stream,
            decoding_options,
        )?;
        let is_online = <bool as crate::BinaryEncoder>::decode(
            stream,
            decoding_options,
        )?;
        Ok(Self {
