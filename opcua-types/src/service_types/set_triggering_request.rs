...
impl crate::MessageInfo for SetTriggeringRequest {
    fn object_id(&self) -> crate::ObjectId {
        crate::ObjectId::SetTriggeringRequest_Encoding_DefaultBinary
    }
}
impl crate::BinaryEncoder for SetTriggeringRequest {
    ...
    fn decode<S: std::io::Read>(
        ...
        let triggering_item_id = <u32 as crate::BinaryEncoder>::decode(
                stream,
                decoding_options,
            )
            .map_err(|e| e.with_request_handle(__request_handle))?;
