...
impl crate::MessageInfo for CartesianCoordinates {
    fn object_id(&self) -> crate::ObjectId {
        crate::ObjectId::CartesianCoordinates_Encoding_DefaultBinary
    }
}
impl crate::BinaryEncoder for CartesianCoordinates {
