...
impl crate::MessageInfo for AdditionalParametersType {
    fn object_id(&self) -> crate::ObjectId {
        crate::ObjectId::AdditionalParametersType_Encoding_DefaultBinary
    }
}
impl crate::BinaryEncoder for AdditionalParametersType {
