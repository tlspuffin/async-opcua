...
pub struct FieldTargetDataType {
    ...
    pub receiver_index_range: crate::string::UAString,
    pub target_node_id: crate::node_id::NodeId,
    pub attribute_id: u32,
    pub write_index_range: crate::string::UAString,
    pub override_value_handling: super::enums::OverrideValueHandling,
    pub override_value: crate::variant::Variant,
}
impl crate::MessageInfo for FieldTargetDataType {
    fn object_id(&self) -> crate::ObjectId {
        crate::ObjectId::FieldTargetDataType_Encoding_DefaultBinary
    }
}
impl crate::BinaryEncoder for FieldTargetDataType {
    ...
    fn decode<S: std::io::Read>(
        ...
        let receiver_index_range = <crate::string::UAString as crate::BinaryEncoder>::decode(
            stream,
            decoding_options,
        )?;
        let target_node_id = <crate::node_id::NodeId as crate::BinaryEncoder>::decode(
            stream,
            decoding_options,
        )?;
        ...
        let write_index_range = <crate::string::UAString as crate::BinaryEncoder>::decode(
            stream,
            decoding_options,
        )?;
        let override_value_handling = <super::enums::OverrideValueHandling as crate::BinaryEncoder>::decode(
            stream,
            decoding_options,
        )?;
        let override_value = <crate::variant::Variant as crate::BinaryEncoder>::decode(
            stream,
            decoding_options,
        )?;
        Ok(Self {
