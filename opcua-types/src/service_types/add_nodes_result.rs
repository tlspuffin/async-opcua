...
pub struct AddNodesResult {
    ...
    pub added_node_id: crate::node_id::NodeId,
}
impl crate::MessageInfo for AddNodesResult {
    fn object_id(&self) -> crate::ObjectId {
        crate::ObjectId::AddNodesResult_Encoding_DefaultBinary
    }
}
impl crate::BinaryEncoder for AddNodesResult {
    ...
    fn decode<S: std::io::Read>(
        ...
        let added_node_id = <crate::node_id::NodeId as crate::BinaryEncoder>::decode(
            stream,
            decoding_options,
        )?;
