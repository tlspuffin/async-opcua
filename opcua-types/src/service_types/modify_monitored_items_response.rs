...
impl crate::MessageInfo for ModifyMonitoredItemsResponse {
    fn object_id(&self) -> crate::ObjectId {
        crate::ObjectId::ModifyMonitoredItemsResponse_Encoding_DefaultBinary
    }
}
impl crate::BinaryEncoder for ModifyMonitoredItemsResponse {
