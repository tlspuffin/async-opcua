...
impl crate::MessageInfo for MonitoredItemCreateResult {
    fn object_id(&self) -> crate::ObjectId {
        crate::ObjectId::MonitoredItemCreateResult_Encoding_DefaultBinary
    }
}
impl crate::BinaryEncoder for MonitoredItemCreateResult {
    ...
    fn decode<S: std::io::Read>(
        ...
        let monitored_item_id = <u32 as crate::BinaryEncoder>::decode(
            stream,
            decoding_options,
        )?;
