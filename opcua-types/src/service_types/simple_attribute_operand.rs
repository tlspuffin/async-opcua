...
pub struct SimpleAttributeOperand {
    pub type_definition_id: crate::node_id::NodeId,
    pub browse_path: Option<Vec<crate::qualified_name::QualifiedName>>,
    pub attribute_id: u32,
    pub index_range: crate::string::UAString,
}
impl crate::BinaryEncoder for SimpleAttributeOperand {
    ...
    fn decode<S: std::io::Read>(
        ...
        let type_definition_id = <crate::node_id::NodeId as crate::BinaryEncoder>::decode(
            stream,
            decoding_options,
        )?;
