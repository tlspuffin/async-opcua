...
pub struct RedundantServerDataType {
    pub server_id: crate::string::UAString,
    pub service_level: u8,
    pub server_state: super::enums::ServerState,
}
impl crate::MessageInfo for RedundantServerDataType {
    fn object_id(&self) -> crate::ObjectId {
        crate::ObjectId::RedundantServerDataType_Encoding_DefaultBinary
    }
}
impl crate::BinaryEncoder for RedundantServerDataType {
    ...
    fn decode<S: std::io::Read>(
        ...
        let server_id = <crate::string::UAString as crate::BinaryEncoder>::decode(
            stream,
            decoding_options,
        )?;
        let service_level = <u8 as crate::BinaryEncoder>::decode(
            stream,
            decoding_options,
        )?;
        let server_state = <super::enums::ServerState as crate::BinaryEncoder>::decode(
            stream,
            decoding_options,
        )?;
        Ok(Self {
