...
impl crate::MessageInfo for RegisterServerResponse {
    fn object_id(&self) -> crate::ObjectId {
        crate::ObjectId::RegisterServerResponse_Encoding_DefaultBinary
    }
}
impl crate::BinaryEncoder for RegisterServerResponse {
