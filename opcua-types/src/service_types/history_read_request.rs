...
pub struct HistoryReadRequest {
    ...
    pub history_read_details: crate::extension_object::ExtensionObject,
...
impl crate::MessageInfo for HistoryReadRequest {
    fn object_id(&self) -> crate::ObjectId {
        crate::ObjectId::HistoryReadRequest_Encoding_DefaultBinary
    }
}
impl crate::BinaryEncoder for HistoryReadRequest {
    ...
    fn decode<S: std::io::Read>(
        ...
        let history_read_details = <crate::extension_object::ExtensionObject as crate::BinaryEncoder>::decode(
                stream,
                decoding_options,
            )
        ...
        let timestamps_to_return = <super::enums::TimestampsToReturn as crate::BinaryEncoder>::decode(
            ...
            .map_err(|e| e.with_request_handle(__request_handle))?;
        let release_continuation_points = <bool as crate::BinaryEncoder>::decode(
                stream,
                decoding_options,
            )
            .map_err(|e| e.with_request_handle(__request_handle))?;
