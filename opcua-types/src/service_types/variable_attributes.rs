...
impl crate::BinaryEncoder for VariableAttributes {
    ...
    fn decode<S: std::io::Read>(
        ...
        let access_level = <u8 as crate::BinaryEncoder>::decode(
            stream,
            decoding_options,
        )?;
        let user_access_level = <u8 as crate::BinaryEncoder>::decode(
            stream,
            decoding_options,
        )?;
        let minimum_sampling_interval = <f64 as crate::BinaryEncoder>::decode(
            stream,
            decoding_options,
        )?;
        let historizing = <bool as crate::BinaryEncoder>::decode(
            stream,
            decoding_options,
        )?;
        Ok(Self {
