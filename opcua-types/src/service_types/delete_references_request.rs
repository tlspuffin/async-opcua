...
impl opcua::types::BinaryEncodable for DeleteReferencesRequest {
    ...
    fn byte_len(&self, ctx: &opcua::types::Context<'_>) -> usize {
        ...
        size += self.references_to_delete.byte_len(ctx);
        size
    }
    #[allow(unused_variables)]
    fn encode<S: std::io::Write + ?Sized>(
        ...
        size += self.references_to_delete.encode(stream, ctx)?;
        Ok(size)
    }
}
impl opcua::types::BinaryDecodable for DeleteReferencesRequest {
    #[allow(unused_variables)]
    fn decode<S: std::io::Read + ?Sized>(
        ...
        Ok(Self {
            request_header,
            references_to_delete: opcua::types::BinaryDecodable::decode(stream, ctx)
