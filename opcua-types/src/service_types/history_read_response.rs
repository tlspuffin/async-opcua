...
impl crate::MessageInfo for HistoryReadResponse {
    fn object_id(&self) -> crate::ObjectId {
        crate::ObjectId::HistoryReadResponse_Encoding_DefaultBinary
    }
}
impl crate::BinaryEncoder for HistoryReadResponse {
