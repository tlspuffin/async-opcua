...
impl crate::MessageInfo for CreateSessionRequest {
    fn object_id(&self) -> crate::ObjectId {
        crate::ObjectId::CreateSessionRequest_Encoding_DefaultBinary
    }
}
impl crate::BinaryEncoder for CreateSessionRequest {
    ...
    fn decode<S: std::io::Read>(
        ...
        let client_certificate = <crate::byte_string::ByteString as crate::BinaryEncoder>::decode(
            ...
            .map_err(|e| e.with_request_handle(__request_handle))?;
        let requested_session_timeout = <f64 as crate::BinaryEncoder>::decode(
                stream,
                decoding_options,
            )
            .map_err(|e| e.with_request_handle(__request_handle))?;
