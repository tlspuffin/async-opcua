...
impl crate::MessageInfo for RepublishRequest {
    fn object_id(&self) -> crate::ObjectId {
        crate::ObjectId::RepublishRequest_Encoding_DefaultBinary
    }
}
impl crate::BinaryEncoder for RepublishRequest {
    ...
    fn decode<S: std::io::Read>(
        ...
        let retransmit_sequence_number = <u32 as crate::BinaryEncoder>::decode(
                stream,
                decoding_options,
            )
            .map_err(|e| e.with_request_handle(__request_handle))?;
