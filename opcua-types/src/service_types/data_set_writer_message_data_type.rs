...
impl crate::MessageInfo for DataSetWriterMessageDataType {
    fn object_id(&self) -> crate::ObjectId {
        crate::ObjectId::DataSetWriterMessageDataType_Encoding_DefaultBinary
    }
}
impl crate::BinaryEncoder for DataSetWriterMessageDataType {
