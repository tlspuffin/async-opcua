...
impl crate::MessageInfo for PubSubGroupDataType {
    fn object_id(&self) -> crate::ObjectId {
        crate::ObjectId::PubSubGroupDataType_Encoding_DefaultBinary
    }
}
impl crate::BinaryEncoder for PubSubGroupDataType {
