...
impl crate::MessageInfo for DeleteSubscriptionsRequest {
    fn object_id(&self) -> crate::ObjectId {
        crate::ObjectId::DeleteSubscriptionsRequest_Encoding_DefaultBinary
    }
}
impl crate::BinaryEncoder for DeleteSubscriptionsRequest {
