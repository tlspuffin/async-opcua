...
impl crate::MessageInfo for ConfigurationVersionDataType {
    fn object_id(&self) -> crate::ObjectId {
        crate::ObjectId::ConfigurationVersionDataType_Encoding_DefaultBinary
    }
}
impl crate::BinaryEncoder for ConfigurationVersionDataType {
    ...
    fn decode<S: std::io::Read>(
        ...
        let major_version = <u32 as crate::BinaryEncoder>::decode(
            stream,
            decoding_options,
        )?;
        let minor_version = <u32 as crate::BinaryEncoder>::decode(
            stream,
            decoding_options,
        )?;
        Ok(Self {
