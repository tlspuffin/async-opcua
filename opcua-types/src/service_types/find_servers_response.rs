...
impl crate::MessageInfo for FindServersResponse {
    fn object_id(&self) -> crate::ObjectId {
        crate::ObjectId::FindServersResponse_Encoding_DefaultBinary
    }
}
impl crate::BinaryEncoder for FindServersResponse {
