...
impl crate::MessageInfo for MonitoredItemCreateRequest {
    fn object_id(&self) -> crate::ObjectId {
        crate::ObjectId::MonitoredItemCreateRequest_Encoding_DefaultBinary
    }
}
impl crate::BinaryEncoder for MonitoredItemCreateRequest {
    ...
    fn decode<S: std::io::Read>(
        ...
        let item_to_monitor = <super::read_value_id::ReadValueId as crate::BinaryEncoder>::decode(
            stream,
            decoding_options,
        )?;
        ...
        let requested_parameters = <super::monitoring_parameters::MonitoringParameters as crate::BinaryEncoder>::decode(
            stream,
            decoding_options,
        )?;
        Ok(Self {
