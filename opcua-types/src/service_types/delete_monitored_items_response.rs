...
impl crate::MessageInfo for DeleteMonitoredItemsResponse {
    fn object_id(&self) -> crate::ObjectId {
        crate::ObjectId::DeleteMonitoredItemsResponse_Encoding_DefaultBinary
    }
}
impl crate::BinaryEncoder for DeleteMonitoredItemsResponse {
