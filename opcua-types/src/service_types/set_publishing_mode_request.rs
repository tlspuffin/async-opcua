...
impl crate::MessageInfo for SetPublishingModeRequest {
    fn object_id(&self) -> crate::ObjectId {
        crate::ObjectId::SetPublishingModeRequest_Encoding_DefaultBinary
    }
}
impl crate::BinaryEncoder for SetPublishingModeRequest {
