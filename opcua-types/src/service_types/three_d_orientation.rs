...
impl crate::BinaryEncoder for ThreeDOrientation {
    ...
    fn decode<S: std::io::Read>(
        ...
        let a = <f64 as crate::BinaryEncoder>::decode(stream, decoding_options)?;
        let b = <f64 as crate::BinaryEncoder>::decode(stream, decoding_options)?;
        let c = <f64 as crate::BinaryEncoder>::decode(stream, decoding_options)?;
        Ok(Self { a, b, c })
    }
}
