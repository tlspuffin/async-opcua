...
impl opcua::types::BinaryEncodable for HistoryUpdateRequest {
    ...
    fn byte_len(&self, ctx: &opcua::types::Context<'_>) -> usize {
        ...
        size += self.history_update_details.byte_len(ctx);
        size
    }
    #[allow(unused_variables)]
    fn encode<S: std::io::Write + ?Sized>(
        ...
        size += self.history_update_details.encode(stream, ctx)?;
        Ok(size)
    }
}
impl opcua::types::BinaryDecodable for HistoryUpdateRequest {
    #[allow(unused_variables)]
    fn decode<S: std::io::Read + ?Sized>(
        ...
        Ok(Self {
            request_header,
            history_update_details: opcua::types::BinaryDecodable::decode(stream, ctx)
