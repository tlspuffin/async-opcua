...
impl crate::MessageInfo for PubSubConfigurationDataType {
    fn object_id(&self) -> crate::ObjectId {
        crate::ObjectId::PubSubConfigurationDataType_Encoding_DefaultBinary
    }
}
impl crate::BinaryEncoder for PubSubConfigurationDataType {
