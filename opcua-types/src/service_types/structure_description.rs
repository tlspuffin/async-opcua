...
impl crate::BinaryEncoder for StructureDescription {
    ...
    fn decode<S: std::io::Read>(
        ...
        let structure_definition = <super::structure_definition::StructureDefinition as crate::BinaryEncoder>::decode(
            stream,
            decoding_options,
        )?;
        Ok(Self {
