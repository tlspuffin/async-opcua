...
pub struct AggregateFilterResult {
    pub revised_start_time: crate::date_time::DateTime,
...
impl crate::BinaryEncoder for AggregateFilterResult {
    ...
    fn decode<S: std::io::Read>(
        ...
        let revised_start_time = <crate::date_time::DateTime as crate::BinaryEncoder>::decode(
            stream,
            decoding_options,
        )?;
        let revised_processing_interval = <f64 as crate::BinaryEncoder>::decode(
            stream,
            decoding_options,
        )?;
        let revised_aggregate_configuration = <super::aggregate_configuration::AggregateConfiguration as crate::BinaryEncoder>::decode(
            stream,
            decoding_options,
        )?;
        Ok(Self {
