...
pub struct ReferenceTypeAttributes {
    ...
    pub symmetric: bool,
    pub inverse_name: crate::localized_text::LocalizedText,
}
impl crate::BinaryEncoder for ReferenceTypeAttributes {
    ...
    fn decode<S: std::io::Read>(
        ...
        let symmetric = <bool as crate::BinaryEncoder>::decode(
            stream,
            decoding_options,
        )?;
        let inverse_name = <crate::localized_text::LocalizedText as crate::BinaryEncoder>::decode(
            stream,
            decoding_options,
        )?;
        Ok(Self {
