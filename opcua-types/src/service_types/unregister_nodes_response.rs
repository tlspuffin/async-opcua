...
impl crate::MessageInfo for UnregisterNodesResponse {
    fn object_id(&self) -> crate::ObjectId {
        crate::ObjectId::UnregisterNodesResponse_Encoding_DefaultBinary
    }
}
impl crate::BinaryEncoder for UnregisterNodesResponse {
