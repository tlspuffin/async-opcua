...
impl opcua::types::BinaryEncodable for MethodAttributes {
    ...
    fn byte_len(&self, ctx: &opcua::types::Context<'_>) -> usize {
        ...
        size += self.executable.byte_len(ctx);
        size += self.user_executable.byte_len(ctx);
        size
    }
    #[allow(unused_variables)]
    fn encode<S: std::io::Write + ?Sized>(
        ...
        size += self.executable.encode(stream, ctx)?;
        size += self.user_executable.encode(stream, ctx)?;
        Ok(size)
    }
}
impl opcua::types::BinaryDecodable for MethodAttributes {
    ...
    fn decode<S: std::io::Read + ?Sized>(
        ...
        Ok(Self {
            ...
            executable: opcua::types::BinaryDecodable::decode(stream, ctx)?,
            user_executable: opcua::types::BinaryDecodable::decode(stream, ctx)?,
        })
    }
}
