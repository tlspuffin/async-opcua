...
impl crate::MessageInfo for RegisterServerRequest {
    fn object_id(&self) -> crate::ObjectId {
        crate::ObjectId::RegisterServerRequest_Encoding_DefaultBinary
    }
}
impl crate::BinaryEncoder for RegisterServerRequest {
