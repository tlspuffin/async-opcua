...
impl crate::BinaryEncoder for ThreeDCartesianCoordinates {
    ...
    fn decode<S: std::io::Read>(
        ...
        let y = <f64 as crate::BinaryEncoder>::decode(stream, decoding_options)?;
        let z = <f64 as crate::BinaryEncoder>::decode(stream, decoding_options)?;
        Ok(Self { x, y, z })
    }
}
