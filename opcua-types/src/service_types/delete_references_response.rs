...
impl crate::MessageInfo for DeleteReferencesResponse {
    fn object_id(&self) -> crate::ObjectId {
        crate::ObjectId::DeleteReferencesResponse_Encoding_DefaultBinary
    }
}
impl crate::BinaryEncoder for DeleteReferencesResponse {
