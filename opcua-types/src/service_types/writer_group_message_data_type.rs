...
impl crate::MessageInfo for WriterGroupMessageDataType {
    fn object_id(&self) -> crate::ObjectId {
        crate::ObjectId::WriterGroupMessageDataType_Encoding_DefaultBinary
    }
}
impl crate::BinaryEncoder for WriterGroupMessageDataType {
