...
impl crate::MessageInfo for HistoryReadValueId {
    fn object_id(&self) -> crate::ObjectId {
        crate::ObjectId::HistoryReadValueId_Encoding_DefaultBinary
    }
}
impl crate::BinaryEncoder for HistoryReadValueId {
    ...
    fn decode<S: std::io::Read>(
        ...
        let data_encoding = <crate::qualified_name::QualifiedName as crate::BinaryEncoder>::decode(
            stream,
            decoding_options,
        )?;
