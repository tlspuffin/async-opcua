...
impl crate::MessageInfo for DeleteSubscriptionsResponse {
    fn object_id(&self) -> crate::ObjectId {
        crate::ObjectId::DeleteSubscriptionsResponse_Encoding_DefaultBinary
    }
}
impl crate::BinaryEncoder for DeleteSubscriptionsResponse {
