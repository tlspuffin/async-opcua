...
impl crate::MessageInfo for QueryFirstResponse {
    fn object_id(&self) -> crate::ObjectId {
        crate::ObjectId::QueryFirstResponse_Encoding_DefaultBinary
    }
}
impl crate::BinaryEncoder for QueryFirstResponse {
    ...
    fn decode<S: std::io::Read>(
        ...
        > as crate::BinaryEncoder>::decode(stream, decoding_options)
            .map_err(|e| e.with_request_handle(__request_handle))?;
        let filter_result = <super::content_filter_result::ContentFilterResult as crate::BinaryEncoder>::decode(
                stream,
                decoding_options,
            )
            .map_err(|e| e.with_request_handle(__request_handle))?;
