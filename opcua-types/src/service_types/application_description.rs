...
pub struct ApplicationDescription {
    pub application_uri: crate::string::UAString,
    ...
    pub discovery_profile_uri: crate::string::UAString,
    pub discovery_urls: Option<Vec<crate::string::UAString>>,
}
impl crate::MessageInfo for ApplicationDescription {
    fn object_id(&self) -> crate::ObjectId {
        crate::ObjectId::ApplicationDescription_Encoding_DefaultBinary
    }
}
impl crate::BinaryEncoder for ApplicationDescription {
    ...
    fn decode<S: std::io::Read>(
        ...
        let application_uri = <crate::string::UAString as crate::BinaryEncoder>::decode(
            stream,
            decoding_options,
        )?;
        ...
        let application_name = <crate::localized_text::LocalizedText as crate::BinaryEncoder>::decode(
            stream,
            decoding_options,
        )?;
        let application_type = <super::enums::ApplicationType as crate::BinaryEncoder>::decode(
            stream,
            decoding_options,
        )?;
        ...
        let discovery_profile_uri = <crate::string::UAString as crate::BinaryEncoder>::decode(
            stream,
            decoding_options,
        )?;
