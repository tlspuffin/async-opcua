...
impl crate::MessageInfo for MonitoringFilterResult {
    fn object_id(&self) -> crate::ObjectId {
        crate::ObjectId::MonitoringFilterResult_Encoding_DefaultBinary
    }
}
impl crate::BinaryEncoder for MonitoringFilterResult {
