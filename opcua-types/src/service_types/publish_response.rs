...
impl crate::MessageInfo for PublishResponse {
    fn object_id(&self) -> crate::ObjectId {
        crate::ObjectId::PublishResponse_Encoding_DefaultBinary
    }
}
impl crate::BinaryEncoder for PublishResponse {
    ...
    fn decode<S: std::io::Read>(
        ...
        > as crate::BinaryEncoder>::decode(stream, decoding_options)
            .map_err(|e| e.with_request_handle(__request_handle))?;
        let more_notifications = <bool as crate::BinaryEncoder>::decode(
                stream,
                decoding_options,
            )
            .map_err(|e| e.with_request_handle(__request_handle))?;
