...
impl crate::MessageInfo for CreateMonitoredItemsResponse {
    fn object_id(&self) -> crate::ObjectId {
        crate::ObjectId::CreateMonitoredItemsResponse_Encoding_DefaultBinary
    }
}
impl crate::BinaryEncoder for CreateMonitoredItemsResponse {
