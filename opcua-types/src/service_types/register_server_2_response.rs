...
impl opcua::types::BinaryEncodable for RegisterServer2Response {
    ...
    fn byte_len(&self, ctx: &opcua::types::Context<'_>) -> usize {
        ...
        size += self.configuration_results.byte_len(ctx);
    ...
    fn encode<S: std::io::Write + ?Sized>(
        ...
        size += self.configuration_results.encode(stream, ctx)?;
...
impl opcua::types::BinaryDecodable for RegisterServer2Response {
    ...
    fn decode<S: std::io::Read + ?Sized>(
        ...
        Ok(Self {
            response_header,
            configuration_results: opcua::types::BinaryDecodable::decode(stream, ctx)
