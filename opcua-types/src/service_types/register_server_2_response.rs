...
pub struct RegisterServer2Response {
    ...
    pub configuration_results: Option<Vec<crate::status_code::StatusCode>>,
    pub diagnostic_infos: Option<Vec<crate::diagnostic_info::DiagnosticInfo>>,
}
impl crate::MessageInfo for RegisterServer2Response {
    fn object_id(&self) -> crate::ObjectId {
        crate::ObjectId::RegisterServer2Response_Encoding_DefaultBinary
    }
}
impl crate::BinaryEncoder for RegisterServer2Response {
