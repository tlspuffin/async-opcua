...
pub struct SessionDiagnosticsDataType {
    ...
    pub session_name: crate::string::UAString,
    ...
    pub client_connection_time: crate::date_time::DateTime,
    pub client_last_contact_time: crate::date_time::DateTime,
...
impl crate::MessageInfo for SessionDiagnosticsDataType {
    fn object_id(&self) -> crate::ObjectId {
        crate::ObjectId::SessionDiagnosticsDataType_Encoding_DefaultBinary
    }
}
impl crate::BinaryEncoder for SessionDiagnosticsDataType {
    ...
    fn decode<S: std::io::Read>(
        ...
        let session_name = <crate::string::UAString as crate::BinaryEncoder>::decode(
            stream,
            decoding_options,
        )?;
        let client_description = <super::application_description::ApplicationDescription as crate::BinaryEncoder>::decode(
            stream,
            decoding_options,
        )?;
        ...
        let actual_session_timeout = <f64 as crate::BinaryEncoder>::decode(
            stream,
            decoding_options,
        )?;
        let max_response_message_size = <u32 as crate::BinaryEncoder>::decode(
            stream,
            decoding_options,
        )?;
        let client_connection_time = <crate::date_time::DateTime as crate::BinaryEncoder>::decode(
            stream,
            decoding_options,
        )?;
        let client_last_contact_time = <crate::date_time::DateTime as crate::BinaryEncoder>::decode(
            stream,
            decoding_options,
        )?;
        let current_subscriptions_count = <u32 as crate::BinaryEncoder>::decode(
            stream,
            decoding_options,
        )?;
        let current_monitored_items_count = <u32 as crate::BinaryEncoder>::decode(
            stream,
            decoding_options,
        )?;
        let current_publish_requests_in_queue = <u32 as crate::BinaryEncoder>::decode(
            stream,
            decoding_options,
        )?;
        let total_request_count = <super::service_counter_data_type::ServiceCounterDataType as crate::BinaryEncoder>::decode(
            stream,
            decoding_options,
        )?;
        let unauthorized_request_count = <u32 as crate::BinaryEncoder>::decode(
            stream,
            decoding_options,
        )?;
        let read_count = <super::service_counter_data_type::ServiceCounterDataType as crate::BinaryEncoder>::decode(
            stream,
            decoding_options,
        )?;
        let history_read_count = <super::service_counter_data_type::ServiceCounterDataType as crate::BinaryEncoder>::decode(
            stream,
            decoding_options,
        )?;
        let write_count = <super::service_counter_data_type::ServiceCounterDataType as crate::BinaryEncoder>::decode(
            stream,
            decoding_options,
        )?;
        let history_update_count = <super::service_counter_data_type::ServiceCounterDataType as crate::BinaryEncoder>::decode(
            stream,
            decoding_options,
        )?;
        let call_count = <super::service_counter_data_type::ServiceCounterDataType as crate::BinaryEncoder>::decode(
            stream,
            decoding_options,
        )?;
        let create_monitored_items_count = <super::service_counter_data_type::ServiceCounterDataType as crate::BinaryEncoder>::decode(
            stream,
            decoding_options,
        )?;
        let modify_monitored_items_count = <super::service_counter_data_type::ServiceCounterDataType as crate::BinaryEncoder>::decode(
            stream,
            decoding_options,
        )?;
        let set_monitoring_mode_count = <super::service_counter_data_type::ServiceCounterDataType as crate::BinaryEncoder>::decode(
            stream,
            decoding_options,
        )?;
        let set_triggering_count = <super::service_counter_data_type::ServiceCounterDataType as crate::BinaryEncoder>::decode(
            stream,
            decoding_options,
        )?;
        let delete_monitored_items_count = <super::service_counter_data_type::ServiceCounterDataType as crate::BinaryEncoder>::decode(
            stream,
            decoding_options,
        )?;
        let create_subscription_count = <super::service_counter_data_type::ServiceCounterDataType as crate::BinaryEncoder>::decode(
            stream,
            decoding_options,
        )?;
        let modify_subscription_count = <super::service_counter_data_type::ServiceCounterDataType as crate::BinaryEncoder>::decode(
            stream,
            decoding_options,
        )?;
        let set_publishing_mode_count = <super::service_counter_data_type::ServiceCounterDataType as crate::BinaryEncoder>::decode(
            stream,
            decoding_options,
        )?;
        let publish_count = <super::service_counter_data_type::ServiceCounterDataType as crate::BinaryEncoder>::decode(
            stream,
            decoding_options,
        )?;
        let republish_count = <super::service_counter_data_type::ServiceCounterDataType as crate::BinaryEncoder>::decode(
            stream,
            decoding_options,
        )?;
        let transfer_subscriptions_count = <super::service_counter_data_type::ServiceCounterDataType as crate::BinaryEncoder>::decode(
            stream,
            decoding_options,
        )?;
        let delete_subscriptions_count = <super::service_counter_data_type::ServiceCounterDataType as crate::BinaryEncoder>::decode(
            stream,
            decoding_options,
        )?;
        let add_nodes_count = <super::service_counter_data_type::ServiceCounterDataType as crate::BinaryEncoder>::decode(
            stream,
            decoding_options,
        )?;
        let add_references_count = <super::service_counter_data_type::ServiceCounterDataType as crate::BinaryEncoder>::decode(
            stream,
            decoding_options,
        )?;
        let delete_nodes_count = <super::service_counter_data_type::ServiceCounterDataType as crate::BinaryEncoder>::decode(
            stream,
            decoding_options,
        )?;
        let delete_references_count = <super::service_counter_data_type::ServiceCounterDataType as crate::BinaryEncoder>::decode(
            stream,
            decoding_options,
        )?;
        let browse_count = <super::service_counter_data_type::ServiceCounterDataType as crate::BinaryEncoder>::decode(
            stream,
            decoding_options,
        )?;
        let browse_next_count = <super::service_counter_data_type::ServiceCounterDataType as crate::BinaryEncoder>::decode(
            stream,
            decoding_options,
        )?;
        let translate_browse_paths_to_node_ids_count = <super::service_counter_data_type::ServiceCounterDataType as crate::BinaryEncoder>::decode(
            stream,
            decoding_options,
        )?;
        let query_first_count = <super::service_counter_data_type::ServiceCounterDataType as crate::BinaryEncoder>::decode(
            stream,
            decoding_options,
        )?;
        let query_next_count = <super::service_counter_data_type::ServiceCounterDataType as crate::BinaryEncoder>::decode(
            stream,
            decoding_options,
        )?;
        let register_nodes_count = <super::service_counter_data_type::ServiceCounterDataType as crate::BinaryEncoder>::decode(
            stream,
            decoding_options,
        )?;
        let unregister_nodes_count = <super::service_counter_data_type::ServiceCounterDataType as crate::BinaryEncoder>::decode(
            stream,
            decoding_options,
        )?;
        Ok(Self {
