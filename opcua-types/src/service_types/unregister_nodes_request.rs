...
pub struct UnregisterNodesRequest {
    ...
    pub nodes_to_unregister: Option<Vec<crate::node_id::NodeId>>,
}
impl crate::MessageInfo for UnregisterNodesRequest {
    fn object_id(&self) -> crate::ObjectId {
        crate::ObjectId::UnregisterNodesRequest_Encoding_DefaultBinary
    }
}
impl crate::BinaryEncoder for UnregisterNodesRequest {
