...
impl crate::MessageInfo for CreateSubscriptionResponse {
    fn object_id(&self) -> crate::ObjectId {
        crate::ObjectId::CreateSubscriptionResponse_Encoding_DefaultBinary
    }
}
impl crate::BinaryEncoder for CreateSubscriptionResponse {
    ...
    fn decode<S: std::io::Read>(
        ...
        let revised_publishing_interval = <f64 as crate::BinaryEncoder>::decode(
                stream,
                decoding_options,
            )
            .map_err(|e| e.with_request_handle(__request_handle))?;
        let revised_lifetime_count = <u32 as crate::BinaryEncoder>::decode(
                stream,
                decoding_options,
            )
            .map_err(|e| e.with_request_handle(__request_handle))?;
        let revised_max_keep_alive_count = <u32 as crate::BinaryEncoder>::decode(
                stream,
                decoding_options,
            )
            .map_err(|e| e.with_request_handle(__request_handle))?;
