...
impl crate::MessageInfo for SetPublishingModeResponse {
    fn object_id(&self) -> crate::ObjectId {
        crate::ObjectId::SetPublishingModeResponse_Encoding_DefaultBinary
    }
}
impl crate::BinaryEncoder for SetPublishingModeResponse {
