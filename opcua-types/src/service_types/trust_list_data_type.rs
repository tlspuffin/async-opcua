...
pub struct TrustListDataType {
    ...
    pub trusted_certificates: Option<Vec<crate::byte_string::ByteString>>,
    pub trusted_crls: Option<Vec<crate::byte_string::ByteString>>,
    pub issuer_certificates: Option<Vec<crate::byte_string::ByteString>>,
    pub issuer_crls: Option<Vec<crate::byte_string::ByteString>>,
}
impl crate::MessageInfo for TrustListDataType {
    fn object_id(&self) -> crate::ObjectId {
        crate::ObjectId::TrustListDataType_Encoding_DefaultBinary
    }
}
impl crate::BinaryEncoder for TrustListDataType {
    ...
    fn decode<S: std::io::Read>(
        ...
        let specified_lists = <u32 as crate::BinaryEncoder>::decode(
            stream,
            decoding_options,
        )?;
