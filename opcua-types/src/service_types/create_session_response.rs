...
pub struct CreateSessionResponse {
    ...
    pub authentication_token: crate::node_id::NodeId,
    pub revised_session_timeout: f64,
    pub server_nonce: crate::byte_string::ByteString,
    pub server_certificate: crate::byte_string::ByteString,
...
impl crate::MessageInfo for CreateSessionResponse {
    fn object_id(&self) -> crate::ObjectId {
        crate::ObjectId::CreateSessionResponse_Encoding_DefaultBinary
    }
}
impl crate::BinaryEncoder for CreateSessionResponse {
    ...
    fn decode<S: std::io::Read>(
        ...
        let authentication_token = <crate::node_id::NodeId as crate::BinaryEncoder>::decode(
                stream,
                decoding_options,
            )
            .map_err(|e| e.with_request_handle(__request_handle))?;
        let revised_session_timeout = <f64 as crate::BinaryEncoder>::decode(
                stream,
                decoding_options,
            )
            .map_err(|e| e.with_request_handle(__request_handle))?;
        let server_nonce = <crate::byte_string::ByteString as crate::BinaryEncoder>::decode(
            ...
            .map_err(|e| e.with_request_handle(__request_handle))?;
        let server_certificate = <crate::byte_string::ByteString as crate::BinaryEncoder>::decode(
                stream,
                decoding_options,
            )
            .map_err(|e| e.with_request_handle(__request_handle))?;
        ...
        > as crate::BinaryEncoder>::decode(stream, decoding_options)
            .map_err(|e| e.with_request_handle(__request_handle))?;
        let server_signature = <super::signature_data::SignatureData as crate::BinaryEncoder>::decode(
                stream,
                decoding_options,
            )
            .map_err(|e| e.with_request_handle(__request_handle))?;
        let max_request_message_size = <u32 as crate::BinaryEncoder>::decode(
                stream,
                decoding_options,
            )
            .map_err(|e| e.with_request_handle(__request_handle))?;
