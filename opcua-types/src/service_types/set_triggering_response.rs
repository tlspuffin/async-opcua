...
impl opcua::types::BinaryEncodable for SetTriggeringResponse {
    ...
    fn decode<S: std::io::Read>(
        ...
        Ok(Self {
            response_header,
            add_results: opcua::types::BinaryEncodable::decode(stream, decoding_options)
                .map_err(|e| e.with_request_handle(__request_handle))?,
            add_diagnostic_infos: opcua::types::BinaryEncodable::decode(
                    stream,
                    decoding_options,
                )
                .map_err(|e| e.with_request_handle(__request_handle))?,
            remove_results: opcua::types::BinaryEncodable::decode(
                    stream,
                    decoding_options,
                )
                .map_err(|e| e.with_request_handle(__request_handle))?,
            remove_diagnostic_infos: opcua::types::BinaryEncodable::decode(
                    stream,
                    decoding_options,
                )
                .map_err(|e| e.with_request_handle(__request_handle))?,
