...
pub struct SetTriggeringResponse {
    ...
    pub add_results: Option<Vec<crate::status_code::StatusCode>>,
    pub add_diagnostic_infos: Option<Vec<crate::diagnostic_info::DiagnosticInfo>>,
    pub remove_results: Option<Vec<crate::status_code::StatusCode>>,
    pub remove_diagnostic_infos: Option<Vec<crate::diagnostic_info::DiagnosticInfo>>,
}
impl crate::MessageInfo for SetTriggeringResponse {
    fn object_id(&self) -> crate::ObjectId {
        crate::ObjectId::SetTriggeringResponse_Encoding_DefaultBinary
    }
}
impl crate::BinaryEncoder for SetTriggeringResponse {
