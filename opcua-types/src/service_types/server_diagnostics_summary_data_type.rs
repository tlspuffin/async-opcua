...
impl crate::MessageInfo for ServerDiagnosticsSummaryDataType {
    fn object_id(&self) -> crate::ObjectId {
        crate::ObjectId::ServerDiagnosticsSummaryDataType_Encoding_DefaultBinary
    }
}
impl crate::BinaryEncoder for ServerDiagnosticsSummaryDataType {
    ...
    fn decode<S: std::io::Read>(
        ...
        let server_view_count = <u32 as crate::BinaryEncoder>::decode(
            stream,
            decoding_options,
        )?;
        let current_session_count = <u32 as crate::BinaryEncoder>::decode(
            stream,
            decoding_options,
        )?;
        let cumulated_session_count = <u32 as crate::BinaryEncoder>::decode(
            stream,
            decoding_options,
        )?;
        let security_rejected_session_count = <u32 as crate::BinaryEncoder>::decode(
            stream,
            decoding_options,
        )?;
        let rejected_session_count = <u32 as crate::BinaryEncoder>::decode(
            stream,
            decoding_options,
        )?;
        let session_timeout_count = <u32 as crate::BinaryEncoder>::decode(
            stream,
            decoding_options,
        )?;
        let session_abort_count = <u32 as crate::BinaryEncoder>::decode(
            stream,
            decoding_options,
        )?;
        let current_subscription_count = <u32 as crate::BinaryEncoder>::decode(
            stream,
            decoding_options,
        )?;
        let cumulated_subscription_count = <u32 as crate::BinaryEncoder>::decode(
            stream,
            decoding_options,
        )?;
        let publishing_interval_count = <u32 as crate::BinaryEncoder>::decode(
            stream,
            decoding_options,
        )?;
        let security_rejected_requests_count = <u32 as crate::BinaryEncoder>::decode(
            stream,
            decoding_options,
        )?;
        let rejected_requests_count = <u32 as crate::BinaryEncoder>::decode(
            stream,
            decoding_options,
        )?;
        Ok(Self {
