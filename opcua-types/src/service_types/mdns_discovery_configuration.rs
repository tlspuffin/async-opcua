...
pub struct MdnsDiscoveryConfiguration {
    pub mdns_server_name: crate::string::UAString,
    pub server_capabilities: Option<Vec<crate::string::UAString>>,
}
impl crate::BinaryEncoder for MdnsDiscoveryConfiguration {
    ...
    fn decode<S: std::io::Read>(
        ...
        let mdns_server_name = <crate::string::UAString as crate::BinaryEncoder>::decode(
            stream,
            decoding_options,
        )?;
