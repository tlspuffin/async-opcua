...
impl crate::MessageInfo for CloseSessionResponse {
    fn object_id(&self) -> crate::ObjectId {
        crate::ObjectId::CloseSessionResponse_Encoding_DefaultBinary
    }
}
impl crate::BinaryEncoder for CloseSessionResponse {
