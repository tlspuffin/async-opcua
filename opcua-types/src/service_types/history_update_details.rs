...
impl crate::MessageInfo for HistoryUpdateDetails {
    fn object_id(&self) -> crate::ObjectId {
        crate::ObjectId::HistoryUpdateDetails_Encoding_DefaultBinary
    }
}
impl crate::BinaryEncoder for HistoryUpdateDetails {
