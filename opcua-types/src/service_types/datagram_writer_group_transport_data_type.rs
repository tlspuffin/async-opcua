...
impl crate::BinaryEncoder for DatagramWriterGroupTransportDataType {
    ...
    fn decode<S: std::io::Read>(
        ...
        let message_repeat_count = <u8 as crate::BinaryEncoder>::decode(
            stream,
            decoding_options,
        )?;
        let message_repeat_delay = <f64 as crate::BinaryEncoder>::decode(
            stream,
            decoding_options,
        )?;
        Ok(Self {
