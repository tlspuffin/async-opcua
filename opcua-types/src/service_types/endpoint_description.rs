...
impl crate::MessageInfo for EndpointDescription {
    fn object_id(&self) -> crate::ObjectId {
        crate::ObjectId::EndpointDescription_Encoding_DefaultBinary
    }
}
impl crate::BinaryEncoder for EndpointDescription {
    ...
    fn decode<S: std::io::Read>(
        ...
        let server = <super::application_description::ApplicationDescription as crate::BinaryEncoder>::decode(
            stream,
            decoding_options,
        )?;
        ...
        let security_level = <u8 as crate::BinaryEncoder>::decode(
            stream,
            decoding_options,
        )?;
        Ok(Self {
