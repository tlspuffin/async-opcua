...
impl crate::MessageInfo for DataSetReaderMessageDataType {
    fn object_id(&self) -> crate::ObjectId {
        crate::ObjectId::DataSetReaderMessageDataType_Encoding_DefaultBinary
    }
}
impl crate::BinaryEncoder for DataSetReaderMessageDataType {
