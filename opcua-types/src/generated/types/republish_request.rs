...
impl opcua::types::BinaryEncodable for RepublishRequest {
    ...
    fn byte_len(&self, ctx: &opcua::types::Context<'_>) -> usize {
        ...
        size += self.retransmit_sequence_number.byte_len(ctx);
        size
    }
    #[allow(unused_variables)]
    fn encode<S: std::io::Write + ?Sized>(
        ...
        size += self.retransmit_sequence_number.encode(stream, ctx)?;
        Ok(size)
    }
}
impl opcua::types::BinaryDecodable for RepublishRequest {
    ...
    fn decode<S: std::io::Read + ?Sized>(
        ...
        Ok(Self {
            ...
            retransmit_sequence_number: opcua::types::BinaryDecodable::decode(stream, ctx)
                .map_err(|e| e.with_request_handle(__request_handle))?,
        })
    }
}
