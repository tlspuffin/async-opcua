...
impl opcua::types::BinaryEncodable for AddReferencesRequest {
    ...
    fn byte_len(&self, ctx: &opcua::types::Context<'_>) -> usize {
        ...
        size += self.references_to_add.byte_len(ctx);
        size
    }
    #[allow(unused_variables)]
    fn encode<S: std::io::Write + ?Sized>(
        ...
        size += self.references_to_add.encode(stream, ctx)?;
        Ok(size)
    }
}
impl opcua::types::BinaryDecodable for AddReferencesRequest {
    #[allow(unused_variables)]
    fn decode<S: std::io::Read + ?Sized>(
        ...
        Ok(Self {
            request_header,
            references_to_add: opcua::types::BinaryDecodable::decode(stream, ctx)
