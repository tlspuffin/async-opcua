...
impl opcua::types::BinaryEncodable for SignatureData {
    ...
    fn byte_len(&self, ctx: &opcua::types::Context<'_>) -> usize {
        let mut size = 0usize;
        size += self.algorithm.byte_len(ctx);
    ...
    fn encode<S: std::io::Write + ?Sized>(
        ...
        let mut size = 0usize;
        size += self.algorithm.encode(stream, ctx)?;
        size += self.signature.encode(stream, ctx)?;
        Ok(size)
    }
}
impl opcua::types::BinaryDecodable for SignatureData {
    #[allow(unused_variables)]
    fn decode<S: std::io::Read + ?Sized>(
        ...
        Ok(Self {
            algorithm: opcua::types::BinaryDecodable::decode(stream, ctx)?,
