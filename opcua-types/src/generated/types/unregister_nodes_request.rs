...
impl opcua::types::BinaryEncodable for UnregisterNodesRequest {
    ...
    fn byte_len(&self, ctx: &opcua::types::Context<'_>) -> usize {
        ...
        size += self.nodes_to_unregister.byte_len(ctx);
        size
    }
    #[allow(unused_variables)]
    fn encode<S: std::io::Write + ?Sized>(
        ...
        size += self.nodes_to_unregister.encode(stream, ctx)?;
        Ok(size)
    }
}
impl opcua::types::BinaryDecodable for UnregisterNodesRequest {
    ...
    fn decode<S: std::io::Read + ?Sized>(
        ...
        Ok(Self {
            request_header,
            nodes_to_unregister: opcua::types::BinaryDecodable::decode(stream, ctx)
