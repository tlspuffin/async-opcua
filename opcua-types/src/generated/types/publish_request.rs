...
impl opcua::types::BinaryEncodable for PublishRequest {
    ...
    fn byte_len(&self, ctx: &opcua::types::Context<'_>) -> usize {
        ...
        size += self.subscription_acknowledgements.byte_len(ctx);
        size
    }
    #[allow(unused_variables)]
    fn encode<S: std::io::Write + ?Sized>(
        ...
        size += self.subscription_acknowledgements.encode(stream, ctx)?;
        Ok(size)
    }
}
impl opcua::types::BinaryDecodable for PublishRequest {
    #[allow(unused_variables)]
    fn decode<S: std::io::Read + ?Sized>(
        ...
        Ok(Self {
            request_header,
            subscription_acknowledgements: opcua::types::BinaryDecodable::decode(stream, ctx)
