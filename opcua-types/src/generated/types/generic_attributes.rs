...
impl opcua::types::BinaryEncodable for GenericAttributes {
    ...
    fn byte_len(&self, ctx: &opcua::types::Context<'_>) -> usize {
        ...
        size += self.attribute_values.byte_len(ctx);
        size
    }
    #[allow(unused_variables)]
    fn encode<S: std::io::Write + ?Sized>(
        ...
        size += self.attribute_values.encode(stream, ctx)?;
        Ok(size)
    }
}
impl opcua::types::BinaryDecodable for GenericAttributes {
    #[allow(unused_variables)]
    fn decode<S: std::io::Read + ?Sized>(
        ...
        Ok(Self {
            ...
            attribute_values: opcua::types::BinaryDecodable::decode(stream, ctx)?,
        })
    }
}
